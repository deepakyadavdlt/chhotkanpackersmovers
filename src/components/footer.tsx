...
const services = [
    { name: "Packing and Moving", href: "/services" },
    { name: "Loading and Unloading", href: "/services" },
    { name: "Domestic Moving", href: "/services" },
    { name: "Office Relocations", href: "/services" },
    { name: "Car Transportation", href: "/services" },
    { name: "International Moving", href: "/services" },
];
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start">
                                <div className="w-6 h-6 bg-[#e11c09] rounded-full flex-shrink-0 mt-1 mr-3"></div>
                                <div>
                            ...
                            <div className="flex items-start">
                                <div className="w-6 h-6 bg-[#1037b6] rounded-full flex-shrink-0 mt-1 mr-3"></div>
                                <div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="flex space-x-6">
                            <Link href="/privacy" className="text-gray-400 hover:text-[#e11c09] transition-colors duration-200">
                                Privacy Policy
                            </Link>
                            <Link href="/terms" className="text-gray-400 hover:text-[#1037b6] transition-colors duration-200">
                                Terms of Service
                            </Link>
                            <Link href="/sitemap" className="text-gray-400 hover:text-[#e11c09] transition-colors duration-200">
                                Sitemap
                            </Link>
                        </div>
                    </div>
