            ...
            <section className="relative bg-gradient-to-br from-[#e11c09] via-[#b81500] to-[#1037b6] text-white py-20 lg:py-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
                        <Building2 className="w-5 h-5 text-yellow-300 fill-current" />
                    ...
                    <p className="text-lg lg:text-xl xl:text-2xl text-red-100 max-w-4xl mx-auto leading-relaxed">
                        Professional office relocation services with minimal business disruption and efficient handling of all office equipment and furniture.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
                                <p>
                                    Our office relocation services are designed to handle commercial moves with utmost care and minimal business disruption.
                                    We understand the importance of maintaining business continuity during office relocations.
                                </p>
                                <p>
                                    From small offices to large corporate spaces, we provide comprehensive services including office furniture disassembly,
                                    IT equipment handling, secure transportation, and efficient setup at the new location.
                                </p>
                            </div>
                            <div className="flex flex-wrap gap-4">
                                <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-md border border-gray-100">
                                    ...
                                    <span className="text-sm font-medium text-gray-700">Business Continuity</span>
                                </div>
                                <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-md border border-gray-100">
                                    <CheckCircle className="w-5 h-5 text-[#1037b6]" />
                                    <span className="text-sm font-medium text-gray-700">IT Equipment Handling</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                                ...
                                <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900">Office Moving</h4>
                                            <p className="text-sm text-gray-600">Professional corporate services</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section className="py-20 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: <Building2 className="w-12 h-12 text-[#e11c09]" />,
                                title: "Office Furniture",
                                description: "Professional disassembly and reassembly of office furniture"
                            },
                            {
                                icon: <Truck className="w-12 h-12 text-[#1037b6]" />,
                                title: "IT Equipment",
                                description: "Safe handling and transportation of computers and electronics"
                            },
                            {
                                icon: <Shield className="w-12 h-12 text-[#e11c09]" />,
                                title: "Secure Transport",
                                description: "Protected transportation of sensitive office materials"
                            },
                            {
                                icon: <Users className="w-12 h-12 text-[#1037b6]" />,
                                title: "Expert Team",
                                description: "Trained professionals for office relocations"
                            },
                            {
                                icon: <Clock className="w-12 h-12 text-[#e11c09]" />,
                                title: "Minimal Disruption",
                                description: "Efficient service to maintain business operations"
                            },
                            {
                                icon: <Award className="w-12 h-12 text-[#1037b6]" />,
                                title: "Quality Setup",
                                description: "Professional setup at new location"
                            }
                        ].map((feature, index) => (
                        ...
                        {[
                            {
                                step: "01",
                                title: "Planning",
                                description: "Detailed planning and coordination with your team"
                            },
                            {
                                step: "02",
                                title: "Disassembly",
                                description: "Careful disassembly of office furniture and equipment"
                            },
                            {
                                step: "03",
                                title: "Transportation",
                                description: "Secure transportation to new office location"
                            },
                            {
                                step: "04",
                                title: "Setup",
                                description: "Professional setup and arrangement at new location"
                            }
                        ].map((process, index) => (
                            <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 text-center group hover:-translate-y-2 bg-white overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-br from-[#e11c09]/5 to-[#1037b6]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
