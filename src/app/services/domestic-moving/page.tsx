...
import { Home, Truck, Shield, Clock, Users, CheckCircle, Star, ArrowRight, MapPin, Phone, Mail, Award, Zap } from "lucide-react";
import { domesticMovingImage } from "@/assets/services";
            ...
            <section className="relative bg-gradient-to-br from-[#e11c09] via-[#b81500] to-[#1037b6] text-white py-20 lg:py-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
                        <Home className="w-5 h-5 text-yellow-300 fill-current" />
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
                                <p>
                                    Our domestic moving services are designed to handle residential relocations with utmost care and professionalism.
                                    We understand that moving homes can be stressful, and we're here to make it smooth and hassle-free.
                                </p>
                                <p>
                                    From local moves to long-distance relocations across India, we provide comprehensive services including packing,
                                    loading, transportation, unloading, and unpacking assistance. Our team ensures your belongings reach safely.
                                </p>
                            </div>
                            <div className="flex flex-wrap gap-4">
                                <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-md border border-gray-100">
                                    ...
                                    <span className="text-sm font-medium text-gray-700">Local & Long Distance</span>
                                </div>
                                <div className="flex items-center space-x-2 bg-white px-4 py-2 rounded-full shadow-md border border-gray-100">
                                    <CheckCircle className="w-5 h-5 text-[#1037b6]" />
                                    <span className="text-sm font-medium text-gray-700">Full Service</span>
                                </div>
                            </div>
                        </div>
                        <div className="relative">
                            <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                                <Image
                                    src={domesticMovingImage.src}
                                    alt="Professional Domestic Moving Services"
                                    width={600}
                                    height={400}
                                ...
                                <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900">Home Moving</h4>
                                            <p className="text-sm text-gray-600">Professional residential services</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section className="py-20 bg-gray-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {[
                            {
                                icon: <Home className="w-12 h-12 text-[#e11c09]" />,
                                title: "Residential Moving",
                                description: "Complete home relocation services with care"
                            },
                            {
                                icon: <Truck className="w-12 h-12 text-[#1037b6]" />,
                                title: "Safe Transportation",
                                description: "Secure transportation across India"
                            },
                            {
                            ...
                            },
                            {
                                ...
                                description: "Trained professionals with expertise"
                            },
                            {
                                icon: <Clock className="w-12 h-12 text-[#e11c09]" />,
                                title: "Timely Service",
                                description: "Punctual delivery and setup"
                            },
                            {
                                icon: <Award className="w-12 h-12 text-[#1037b6]" />,
                                title: "Quality Assurance",
                                description: "Highest standards of service"
                            }
                        ].map((feature, index) => (
                        ...
                        {[
                            {
                                step: "01",
                                title: "Consultation",
                                description: "Free consultation and detailed quote for your move"
                            },
                            {
                                step: "02",
                                title: "Packing",
                            ...
                            },
                            {
                                ...
                                description: "Safe transportation to your new location"
                            },
                            {
                                step: "04",
                                title: "Setup",
                                description: "Unpacking and setup assistance at destination"
                            }
                        ].map((process, index) => (
                            <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 text-center group hover:-translate-y-2 bg-white overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-br from-[#e11c09]/5 to-[#1037b6]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            ...
            <section className="py-20 bg-gradient-to-br from-[#1037b6] via-[#0d2b8f] to-[#e11c09] relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                        Contact us today for a free consultation and quote for your domestic moving needs.
                    </p>
