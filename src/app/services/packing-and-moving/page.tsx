...
import { Package, Truck, Shield, Clock, Users, CheckCircle, Star, ArrowRight, MapPin, Phone, Mail, Award, Zap } from "lucide-react";
import { packingAndMovingImage } from "@/assets/services";
import Image from "next/image";

export default function PackingAndMovingPage() {
    return (
            ...
            <section className="relative bg-gradient-to-br from-[#e11c09] via-[#b81500] to-[#1037b6] text-white py-20 lg:py-32 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm rounded-full px-6 py-2 mb-6">
                        <Package className="w-5 h-5 text-yellow-300 fill-current" />
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div className="space-y-6">
                            ...
                            <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
                                <p>
                                    Our packing and moving services are designed to handle all types of goods with utmost care and professionalism.
                                    We employ cutting-edge methods and experienced professionals to ensure your belongings are safely transported.
                                </p>
                                <p>
                                    From fragile items to heavy furniture, we have the expertise and equipment to handle every aspect of your move.
                                    Our comprehensive service includes professional packing, secure loading, safe transportation, and careful unloading.
                                </p>
                            </div>
                            ...
                            <div className="relative overflow-hidden rounded-3xl shadow-2xl">
                                ...
                                <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-2xl p-4 shadow-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-gray-900">Expert Packing</h4>
                                            <p className="text-sm text-gray-600">Professional packing services</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        {[
                            {
                                ...
                                description: "Expert packing with quality materials to protect your belongings"
                            },
                            {
                                icon: <Truck className="w-12 h-12 text-[#1037b6]" />,
                                title: "Safe Transportation",
                                description: "Secure loading and unloading with proper equipment"
                            },
                            {
                            ...
                            },
                            {
                                ...
                                description: "Highest standards of service quality"
                            }
                        ].map((feature, index) => (
                        ...
                        {[
                            {
                                step: "01",
                                title: "Assessment",
                                description: "We assess your packing needs and provide a detailed quote"
                            },
                            {
                                step: "02",
                                title: "Packing",
                                description: "Professional team packs your items with quality materials"
                            },
                            {
                                step: "03",
                                title: "Loading",
                                description: "Safe loading and secure transportation to destination"
                            },
                            {
                                step: "04",
                                title: "Unloading",
                                description: "Careful unloading and unpacking assistance"
                            }
                        ].map((process, index) => (
                            <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 text-center group hover:-translate-y-2 bg-white overflow-hidden">
                                <div className="absolute inset-0 bg-gradient-to-br from-[#e11c09]/5 to-[#1037b6]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            ...
            <section className="py-20 bg-gradient-to-br from-[#1037b6] via-[#0d2b8f] to-[#e11c09] relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    ...
                    <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
                        Contact us today for a free consultation and quote for your packing and moving needs.
                    </p>
